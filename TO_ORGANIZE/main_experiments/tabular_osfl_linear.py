...
def linear_mixup(z, alpha=0.2):
    """
    Standard Linear Interpolation instead of Geodesic.
    """
    ...
    # Linear Mixup Formula: (1 - lambda) * x + lambda * y
        ...
        for _ in range(local_epochs):
            for x, _ in loader:
                ...
                if np.random.random() > 0.3:
                    # CHANGED: Using Linear Mixup here
...
def evaluate_scenarios():
    ...
    print(f"Running OPTIMIZED Linear Mixup SVDD on {device}...")
